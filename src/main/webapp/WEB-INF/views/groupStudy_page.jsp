...
//그룹 공지사항 작성 이동
function makeGroupNotice(){
	$("#number").val('${groupNumber}');
	$("#makeNotice").submit();
}
//공지사항 조회
          ...
          <div class="span8">
            <article>
              ...
              <div class="card-header">
              	공지사항<c:if test="${mentor eq 'true'}">
              		<form id="makeNotice" name="makeNotice" action="/toring/makeGroupNotice" method="post" style="display:none;">
              			<input type="hidden" id="number" name="number">
              		</form>
              		<button class="btn btn-theme pull-right" style="position:relative; top: auto;"onClick="makeGroupNotice();">글 작성</button>
              	</c:if>
              </div>
              <div class="card-body">
					...
					<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
						...
						<tbody>
							<c:forEach var="notice" items="${groupStudyNotice}">
								<tr>
									<td><a href="javascript:void(0);" onClick="groupStudyNotice(${notice.noticeNumber});">${notice.title}</a></td>
...
<!--   <script src="resources/js/jquery.js"></script>  -->
 ...
 <script src="resources/datatables/datatables-demo.js"></script>
  ...
  <form action="/toring/groupStudyNotice" method="post" id="groupStudyNotice">
