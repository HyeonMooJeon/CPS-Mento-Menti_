        ...
        <div class="row">
          ...
          <div class="span9">
              ...
              <div class="row">
                <div class="span9">
                	<div class="table-responsive">
                		<table class="bbsWriteA" width="80%" style="border-collapse:inherit;">
                			<colgroup>
								<col width="50%">
								<col width="23%">
								<col width="27%">
							...
							<tbody>
								<tr>
									<td rowspan="5"><img src="resources/img/mentor/${mentor.userPicture}" class="center"></td>
									<th scope="row">이름</th>
									<td>${mentor.userName}</td>
								</tr>
								<tr>
									<th scope="row"><label for="title"><span class="division">소속</span></label></th>
									<td>${mentor.usertemper}</td>
								</tr>
								<tr>
									<th scope="row"><label for="title"><span class="division">학과</span></label></th>
									<td>${mentor.userDepartment}</td>
								</tr>
								<tr>
									<th scope="row"><label for="title"><span class="division">전공</span></label></th>
									<td>${mentor.userTeaching}</td>
								</tr>
							</tbody>
                		</table>
                	</div>
            ...
            <div class="card-header">
          		<dt><strong>모집 중인 멘토링 리스트 </strong></dt>  
            </div>  
              <div class="card-body">
            	<div class="table-responsive">
