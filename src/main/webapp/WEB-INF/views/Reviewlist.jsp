              ...
              <div class="row">
                <div class="span8">
                  <div class="post-heading"> 
                      <h3><a href="/toring/Reviewlist">후기 게시판 목록</a>
                      <%
        if(!(session.getAttribute("sessionID") == null)) // 로그인이 되었을 때
        { 
	 %>
                      <a href="/toring/ReviewEnrollment" class="btn btn-theme btn-large e_tada pull-right" style='color: #fff';>후기등록</a>
            <%
        }
        else  
        {       
	...
	function reviews() {
		//alert("여기");
		 var table=	 $('#example').DataTable({  
					"ajax": '/toring/reviewenrollmentelist',
					 "retrieve": true,    
