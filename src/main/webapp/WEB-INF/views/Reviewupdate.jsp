														...
														<th scpoe="row"><span>>제목</span></th>
												 		<td><input id="applyTitle" name="applyTitle"
															...
															style="width: 50%" type="text" maxlength="40" 
								 							data-rule="minlen:4" data-msg="제목을 4글자 이상 입력해주세요(40자 내외)" value="${headname}" >
														</td>
													</tr>  
													<tr>
													...
													<td colspan="4"> 
													 ...
													 <input type="button"
														...
														<!--  <button class="btn btn-large btn-theme margintop10" type="submit">Submit message</button> -->
										  				<input type=button class="btn btn-outline-primary pull-right" value="목록" onClick="history.go(-2);">
													</td>  
												</tr>   
											</tbody>
										</table>
			...
			if (headname == "" || headname.length>40 || subject.length>500) {
				...
				$.ajax({ 
					...
					error : function(xhr, status, error) {
						alert("후기에 대한 정보가 없거나 파일크기가 5MB제한입니다."); 
						location.href = "/toring/Reviewlist";
					}
				});
