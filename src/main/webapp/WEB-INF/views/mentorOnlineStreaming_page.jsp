              ...
              <div class="navigation">
                <nav>
                    <ul class="nav topnav">
										...
										<li class="dropdown active"><a href="javascript:void(0);">멘토<i
												class="icon-angle-down"></i></a>
											<ul class="dropdown-menu">
            ...
            <article>
              <div class="row">
                <div class="span9">  
                 ...
                 <dt>*화면이 나오지 않을시 시청하기 버튼을 클릭해주세요</dt>  
					<table id="streaming" class="bbsViewB">   
						<colgroup>
							<col width="30%">
							<col width="70%">
						</colgroup>
						<thead>
							<tr>
								<th colspan="2" class="viewTlt">실시간 멘토링</th>
							</tr>															
						</thead>
						<tbody>
							<tr>
							...
							<td style="width:500px; height:500px;">
								...
								width="100%" height="100%" id="vlc" events="True">
								    ...
								    <param name="Src" value="http://192.168.0.9:8090/?action=stream" />
								...
								<tr>     
									<th colspan="2" style="text-align: center;" >
										<a href="http://192.168.0.9:8090?action=stream" class="btn btn-theme btn-large e_tada" style='color: #fff';>시청하기</a>
									</th> 
								</tr>
						</tbody>
