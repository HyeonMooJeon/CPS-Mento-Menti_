...
<body onload="menteeapply();">
              ...
              <div class="row">
                <div class="span8">
                  <div class="post-heading"> 
                      <h3><a href="/toring/Mymenteeapplylist">멘티 신청 내역</a>
                      </h3>
  ...
  <div id="myreviewDetail" class="modal styled hide fade" role="dialog"  aria-hidden="true">
              ...
              <table>   
                 <form action="/toring/Menteeapplyupdate" name="form1" id="form1" method="POST">
	    		...
	    		<th > <label class="control-label" for="inputname">가능 시간</label></th>
	    			<td >    
	    		 		<input type="text" id="time" name="time" style="background-color: white;  border:none;" readonly>  
          		 	</td>  
    		 </tr>  
              <tr>  
...
function menteeapply(){
	...
	var menteen= "<%=session.getAttribute("sessionNUMBER") %>";
	 var table=	 $('#example').DataTable({  
			"ajax": '/toring/menteelistapply?menteenumber='+menteen,  
			 "retrieve": true,    
	 ...
	 $('#example tbody').on('click', '#del', function () {
		    ...
		    var con_test= confirm(data.headname+"을 삭제 하시겠습니까?");
		   	...
		   	if(con_test == true){ 
		     $('#postnumber').val(data.postnum);
		     
		     var formData = new FormData($("#form")[0]);
				$.ajax({
					 url :"/toring/menteedelete"
					,type:"post"
					,data:formData  
					,processData : false
					,contentType : false
