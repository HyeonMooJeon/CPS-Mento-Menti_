...
//그룹 스터디 공지사항 삭제
function remove(noticeNumber){
	$.ajax({
		 url :"/toring/deleteGroupNotice"
		 ,type:"post"
		 ,dataType:"json"
		 ,data: {number : noticeNumber}
	 	 ,success:function(data){
	 	    if(data.success == 1){
	 	       alert("공지사항이 삭제되었습니다");
	 	       admission(${groupNumber});
	 	    }else{
	 	    	alert("데이터베이스 오류");
	 	    }
          ...
          <div class="span8">
            <article>
              <div class="row">
              	<article>
          		<div class="span8">
          			<label style="margin-top:20px;">게시글</label>
            ...
            <article>
              <div class="row">
                <div class="span8">
					...
					<tbody>
						<tr>
							<th scope="row" class="borderT"><span class="division">등록 날짜</span></th>
							<td class="borderT">${notice.noticeDate}</td>
						</tr>
						<tr>
						...
						<c:if test="${mentor eq 'true'}">
                     		<tr>
								<td colspan="2">
									<button class="btn btn-theme pull-right" onClick="remove(${notice.noticeNumber});">삭제하기</button>
									<form action="/toring/editGroupNotice" method="post">
