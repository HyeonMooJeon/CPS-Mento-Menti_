						...
						<div class="card mb-3">
							<div class="card-body">
								<ul class="nav nav-tabs">
									<li class="active"><a data-toggle="tab" href="#make">멘티 모집</a></li>
									<li><a data-toggle="tab" href="#apply">멘티 신청</a></li>
									<li><a data-toggle="tab" href="#accept">멘티 수락</a>
								</ul>
								...
								<div id="make" class="tab-pane fade in active">
									<div class="card mb-3">
										<div class="card-header">
											<label>1. 먼저 멘토/멘티 가입을 해주세요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘티모집/멘토-멘티가입.PNG">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>2. 멘티 모집에서 글쓰기 버튼을 클릭하세요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘티모집/글쓰기.PNG">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>3. 멘토링 정보를 입력하고 글을 등록해주세요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘티모집/멘토링 글 작성.PNG">
										</div>
									</div>
								</div>
								<!-- 멘티신청 -->
								<div id="apply" class="tab-pane fade">
									<div class="card mb-3">
										...
										<div class="card-body">
											<img src="resources/img/guide/멘토링신청/멘토-멘티가입.PNG">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>2. 마음에 드는 멘토를 선택해주세요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘토링신청/멘토선택.PNG">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>3. 멘토의 멘토링 중 자신이 원하는 멘토링을 클릭해주세요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘토링신청/멘토페이지.png">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>4. 멘토링 정보를 확인하세요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘토링신청/게시글상세내역.png">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>5. 신청하기를 클릭하면 완료</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘토링신청/신청하기.png">
										</div>
									</div>
								</div>
								<!-- 멘티 수락 -->
								<div id="accept" class="tab-pane fade">
									<div class="card mb-3">
										<div class="card-header">
											<label>1. 자신의 멘토링에 신청한 목록을 확인</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘티수락/멘토링 신청.PNG">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>2. 마음에 드는 멘티를 수락</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘티수락/멘티 수락.PNG">
										</div>
									</div>
									<div class="card mb-3">
										<div class="card-header">
											<label>3. 수락하면 그룹스터디가 생겨요</label>
										</div>
										<div class="card-body">
											<img src="resources/img/guide/멘티수락/그룹스터디.PNG">
										</div>
									</div>
								</div>
								</div>
