					...
					<div class="span8">
						<ul class="breadcrumb">
						   <li><a href="/toring/"><i class="icon-home"></i></a><i class="icon-angle-right"></i></li>
				             <li><a href="javascript:void(0);">소개</a><i class="icon-angle-right"></i></li>
				            <li class="active">멘토링 현황</li>
						</ul>
					</div>
				</div>
			</div>   
...
var options = {
	...
	data: [{
		...
		indexLabel: "{label} - {y}%",
		dataPoints: [
			{ y: (${usermentor}/${usercount})*100, label: "멘토" },
			{ y: ((${usercount}-${usermentor})/${usercount})*100, label: "멘티" }
...
var options1 = {
		...
		data: [              
		{
			...
			type: "column",
			dataPoints: [
				{ label: "멘티 신청 현황",  y: ${menteecount}},
				{ label: "멘토링 모집글 현황", y: ${mentorcountnotice}},
				{ label: "멘토링 매칭 현황", y: ${groupstudy}},
			]
		}
		] 
	};
