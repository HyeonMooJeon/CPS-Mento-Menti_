                  ...
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="/toring/Revieewlist">후기게시판</a></li>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li><a href="/my_page_redata">my_page</a><i class="icon-angle-right"></i></li>
         ...
         <div class="span4">
          ...
          <div class="span8">
            <article>
             						<!-- 회원 수정 정보 폼  -->  
             	<h2>본인 인증</h2>
            	<form class="form-horizontal"  action="/toring/passCheckAction" method="post">                   
