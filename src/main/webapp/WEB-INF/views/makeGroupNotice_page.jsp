...
function insert(number){
	var formData= new FormData($("#makeNotice")[0]);
	formData.append("groupNumber",number);
	$.ajax({
		 url :"/toring/addGroupNotice"
		 ,type:"post"
		 ,data:formData
         ,dataType:"json"
         ,processData : false
            ...
            <article>
              <div class="row">
          		...
          		<div class="span8">
          			...
          			<a href="javascript:void(0);" style="margin-top:20px;" class="btn btn-theme pull-right" onClick="admission(${groupNumber});">글 목록으로</a>
          		</div>
          	</article>
            <article>
              <div class="row" style="margin-left:0px;">
              	<form id="makeNotice" name="makeNotice" enctype="multipart/form-data">
				...
				<button class="btn btn-theme btn-large btn-rounded center" style="margin-top: 2em;" onClick="insert(${groupNumber});">등록하기</button>		
              </div>
            </article>
              </div>
            </article>
